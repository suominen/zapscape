...
|---|---|---|---|---|---|
| Linux kernel | mainline | 7.2.4 | 7.2-rc5 | 2026-07-26 | :white_check_mark: Fixed — carries `2abd5287f083` |
| Linux kernel | 7.1.x | 7.1.13 | 7.1.6 | 2026-08-03 | :white_check_mark: Fixed — EOL |
| Linux kernel | 6.18.x | 6.18.50 | 6.18.42 | 2026-08-03 | :white_check_mark: Fixed — LTS |
...
| Rocky Linux | 10 | 6.12.0-211.53.1.el10_2 | 6.12.0-211.39.1.el10_2 | 2026-07-26 | :white_check_mark: Fixed — RHSA-2026:45114 |
| Rocky Linux | 9 | 5.14.0-687.45.1.el9_8 | 5.14.0-687.30.1.el9_8 | 2026-07-27 | :white_check_mark: Fixed — RHSA-2026:45192 |
...
- **Amazon Linux** (via repodata `updateinfo.xml.gz` / `primary.xml.gz`):
  - default `kernel` `6.1.180-225.360` cherry-picks the fix per
    **ALAS2023-2026-2058** (2026-08-17, Important) — fixed; the build sits
    below the upstream 6.1.183 threshold, confirming an Amazon-specific
